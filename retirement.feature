Feature: Retirement Age Testing
  Finding the retirement age,
  So I can retirement in the foreseeable future.

  Scenario Outline: Calculating a retirement age for someone born on inputted year
    Given Birth year of <birth_year> is inputted by user
